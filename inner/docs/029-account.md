...
**Лимит сотрудников (тариф «Бизнес»):** платформенный лимит (не ограничение API) — **до 50 человек** в аккаунте на тарифе «Бизнес» (используется в этом workspace). Превышение → тариф «Private».
