...
**Версия**: 2.0  
**Дата**: 2025-11-06  
**Последнее обновление**: 2026-07-22 (новый раздел «Окружения stage/prod: пары таблиц и селектор» — динамические имена таблиц невозможны; пары таблиц с общим объектом полей + статический селектор из PROJECT_ROOT; общие таблицы по одинаковому id; каверзы схем/лимитов/тестов)
