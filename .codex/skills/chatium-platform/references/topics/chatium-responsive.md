...
> Migrated from `s.chtm.khudoley.pro/.cursor/skills/chatium-responsive/SKILL.md`.
> This is a Codex reference, not an auto-loaded standalone skill. Treat it as a quick topic guide.
> Authoritative documentation: `inner/docs/040-responsive.md`. Before implementing, read the relevant `inner/docs/...` file(s) and use CodeGraph for live examples of symbols/routes.
...
Поля ResponsiveState и ResponsiveStateOptions: `node_modules/@app/responsive/index.d.ts`.
