...
> Migrated from `s.chtm.khudoley.pro/.cursor/skills/chatium-starter-kit/SKILL.md`.
...
Добавляет в существующий Chatium-проект стандартный набор компонентов одной командой/описанием: логирование, таблицы настроек и логов, админ API, структура тестов. Эталон кода — **inner/samples/new_project**; в скилле задаётся только состав и ссылки на файлы образца, без дизайна страниц. Использовать после scaffold или в проекте с уже созданным каркасом.
...
- **.codex/skills/chatium-platform/references/rules.md#chatium-constraints.mdc** — глобальные ограничения платформы
