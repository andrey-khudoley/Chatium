...
> Migrated from `s.chtm.khudoley.pro/.cursor/skills/chatium-analytics-traffic/SKILL.md`.
> This is a Codex reference, not an auto-loaded standalone skill. Treat it as a quick topic guide.
> Authoritative documentation: `inner/docs/016-analytics-traffic.md`. Before implementing, read the relevant `inner/docs/...` file(s) and use CodeGraph for live examples of symbols/routes.
...
- **016-analytics-traffic.md** — Traffic Analytics, queryAi, типы событий, SQL-примеры
