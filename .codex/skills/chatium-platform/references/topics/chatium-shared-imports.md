...
> Migrated from `s.chtm.khudoley.pro/.cursor/skills/chatium-shared-imports/SKILL.md`.
> This is a Codex reference, not an auto-loaded standalone skill. Treat it as a quick topic guide.
> Authoritative documentation: `inner/docs/007-vue.md; inner/docs/001-standards.md`. Before implementing, read the relevant `inner/docs/...` file(s) and use CodeGraph for live examples of symbols/routes.
...
- Правило workspace: `.codex/skills/chatium-platform/references/rules.md#chatium-shared-imports.mdc`
- Общие ограничения: `.codex/skills/chatium-platform/references/rules.md#chatium-constraints.mdc` (Vue / Heap)
