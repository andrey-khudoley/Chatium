...
import { profilePageCss1 } from '../../pagecss/profilePageCss1'
import { profilePageCss2 } from '../../pagecss/profilePageCss2'
  ...
  return (
    <html>
      <head>
        ...
        <style>{profilePageCss1}</style>
        <style>{profilePageCss2}</style>
        <style>{`
          html {
            margin: 0;
            padding: 0;
