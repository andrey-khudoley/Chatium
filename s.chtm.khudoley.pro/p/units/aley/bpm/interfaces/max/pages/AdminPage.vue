...
import MaxControlPanel from '../components/max/MaxControlPanel.vue'
...
// Значения для статус-бара (зеркалят настройки из AdminSettings).
...
// Счётчики дашборда: обновляются по каждой входящей записи лога.
