...
export const DEFAULT_PROJECT_TITLE = 'NeSo Meta Web Interface'
...
export const BODY_TEXT = 'NeSo Meta Web Interface'

/** Подзаголовок домашней страницы */
export const BODY_SUBTEXT = 'Checkout-flow: форма → broker → GetCourse → payment link'
