...
import { runCheckoutIntegrationChecks } from './checkoutIntegrationSuite'
...
export async function runTemplateIntegrationChecks(
  ...
  // Checkout integration checks
  const checkoutResults = await runCheckoutIntegrationChecks(ctx)
