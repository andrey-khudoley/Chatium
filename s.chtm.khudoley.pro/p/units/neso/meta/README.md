...
- Добавлен GetCourse interface module: `interfaces/getcourse` регистрируется в локальном broker-е, публикует `getcourse.raw_event.accepted@1` и содержит Admin-only helper API.
