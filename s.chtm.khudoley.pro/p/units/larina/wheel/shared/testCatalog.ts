...
export const INTEGRATION_SERVER_TEST_BLOCKS: TestCatalogBlock[] = [
  ...
  },
  {
    ...
    tests: [
      ...
      { id: 'gc_passesGcUserCheck_not_found_400', title: 'GC 400 → !allowed, !transient' },
      { id: 'gc_passesGcUserCheck_not_found_404', title: 'GC 404 → !allowed, !transient' },
      { id: 'gc_passesGcUserCheck_upstream_5xx_transient', title: 'GC 5xx upstream → transient' },
      ...
      { id: 'gc_passesGcGroupCheck_not_found_400', title: 'GC 400 групп → !allowed, !transient' },
      { id: 'gc_passesGcGroupCheck_not_found_404', title: 'GC 404 групп → !allowed, !transient' },
