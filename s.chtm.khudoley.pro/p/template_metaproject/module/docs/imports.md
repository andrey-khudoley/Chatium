...
The module does not import files from `p/template_metaproject/core`. It calls core
through `@app/app.runAppFunction` using target app `p/template_metaproject/core`.
