/**
 * Юнит-проверки роутинга и констант project (вынесены из templateUnitSuite ради
 * лимита размера файла). Дописывают результаты в общий массив.
 */
import {
  getFullUrl,
  PROJECT_ROOT,
...
export function runRoutesChecks(results: TemplateUnitTestResult[]): void {
  ...
  tryPush(
    ...
    'routes_PROJECT_ROOT',
    'PROJECT_ROOT',
    () => PROJECT_ROOT === 'p/gateways/lavatop'
  )
