---
name: chatium-api-endpoint
description: Создаёт API-эндпоинт в Chatium с валидацией, авторизацией и обработкой ошибок. Используй при добавлении новых API-роутов.
---
