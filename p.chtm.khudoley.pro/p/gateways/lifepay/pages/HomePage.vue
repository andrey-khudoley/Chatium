...
import { lifepayHomePageMethodsMixin } from './lifepayHomePageMixin'
import { createComponentLogger } from '../shared/logger'
import {
  msToDateTimeParts,
  partsToMs,
  formatDateTime,
  defaultLifepayHomeCounts,
  defaultLifepayHomeApiUrls
...
export default {
  ...
  mixins: [lifepayHomePageMethodsMixin],
  components: {
    Header,
    GlobalGlitch,
    AppFooter,
  ...
  props: {
    ...
    projectRoot: { type: String, default: 'p/gateways/lifepay' },
    initialDateFilter: {
      type: Object,
      default: () => ({})
    },
    apiUrls: {
      type: Object,
      default: () => defaultLifepayHomeApiUrls()
    }
  },
  data() {
    ...
    return {
      ...
      liveMode: false,
      now: Date.now(),
      counts: defaultLifepayHomeCounts(),
      requests: [],
      upstream: [],
      lastUpdated: {
        counts: 0,
