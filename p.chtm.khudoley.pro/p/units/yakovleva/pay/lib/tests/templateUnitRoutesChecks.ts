/**
 * Юнит-проверки роутинга (config/routes) и констант проекта (config/project).
 * Вынесены из templateUnitSuite ради лимита размера файла.
 */
import {
  getFullUrl,
  PROJECT_ROOT,
...
export function runRoutesChecks(results: TemplateUnitTestResult[]): void {
  ...
  tryPush(
    ...
    'routes_PROJECT_ROOT',
    'PROJECT_ROOT',
    () => PROJECT_ROOT === 'p/units/yakovleva/pay'
  )
