...
export const DEFAULT_PROJECT_TITLE = 'BPM Access Point'
...
export const BODY_TEXT = 'BPM Access Point'

/** Подзаголовок домашней страницы */
export const BODY_SUBTEXT = 'Модуль BPM-системы для управления бизнесом'
