...
/** Полная оболочка дизайна CRT (геометрия, сканлайны, tv-glitch, crt-power-on). Без getPreloaderStyles. */
export const crtDesignShellStyles = `
...
/** CSS-переменные и выделение текста для тёмной CRT-темы. */
export const crtThemeVarsStyles = `
  :root {
    --color-bg: #0a0a0a;
...
/** Переиспользуемые стили скроллбара (тёмная тема). */
